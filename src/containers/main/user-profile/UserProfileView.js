        ...
        return (
            <View style={{
                ...
                <View style={[styles.headerActions,AppStyles.row]} >
                    ...
                    <TouchableOpacity onPress={() => {Actions.pop()}} style={[AppStyles.flex1, AppStyles.leftAligned, AppStyles.paddingSml]}>
...
class UserProfileRender extends Component {
    ...
    handleChangeTab = (index) => {
        if (index > 0){
            ...
            if (this.state.headerHeight != HEADER_MAX_HEIGHT){
                Animated.parallel([
                    Animated.spring(
                        this.state.headerHeight,
                        {
        ...
        return(
            <View>
                ...
                <View style={[styles.headerActions,AppStyles.row]} >
                    ...
                    <TouchableOpacity onPress={this._onPressOptions} style={[AppStyles.flex1, AppStyles.rightAligned, AppStyles.paddingSml]}>
    ...
    renderBadge = () => {
        ...
        if (profile.badges.find((b) => {return b.name == 'Admin'} )) {
            badgeName = 'admin'
        }else if (profile.badges.find((b) => {return b.name == 'Staff I'} )){
            badgeName = 'staff'
        }else if (profile.badges.find((b) => {return b.name == 'VIP'} )){
            badgeName = 'vip'
        }else if (profile.badges.find((b) => {return b.name == 'Gold Member'} )){
            badgeName = 'gold'
        }
    ...
    renderHeaderContent = () => {
        ...
        return(
            <Animated.View style={[styles.headerContainer, {height: headerHeight}]}>
                ...
                <BlurView
                    style={{position: "absolute",top: 0, left: 0, bottom: 0, right: 0,zIndex:-998}}

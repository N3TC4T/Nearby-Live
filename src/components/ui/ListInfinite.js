...
import { ScrollableMixin, cloneReferencedElement} from '@lib/util';
...
export default class InfiniteScrollView extends React.Component {
    ...
    static defaultProps = {
        distanceToLoadMore: 150,
        canLoadMore: false,
        scrollEventThrottle: 100,
        renderLoadingIndicator: () => <View style={styles.container}><ActivityIndicator /></View>,
